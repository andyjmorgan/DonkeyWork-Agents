...
public static class ConversationWebSocketEndpoints
{
    ...
    internal static JsonElement ToJsonElement(StreamEventBase evt)
    {
        var bytes = evt switch
        {
            ...
            StreamWebFetchEvent e => JsonSerializer.SerializeToUtf8Bytes(e, AgentJsonContext.Default.StreamWebFetchEvent),
            StreamWebFetchCompleteEvent e => JsonSerializer.SerializeToUtf8Bytes(e, AgentJsonContext.Default.StreamWebFetchCompleteEvent),
            StreamCompactionEvent e => JsonSerializer.SerializeToUtf8Bytes(e, AgentJsonContext.Default.StreamCompactionEvent),

...
public class ProjectsTools
{
    ...
    /// </summary>
    [McpServerTool(Name = "projects_get", Title = "Get Project", ReadOnly = true)]
    ...
    /// </summary>
    [McpServerTool(Name = "projects_create", Title = "Create Project")]
    ...
    /// </summary>
    [McpServerTool(Name = "projects_update", Title = "Update Project")]
    ...
    /// </summary>
    [McpServerTool(Name = "projects_delete", Title = "Delete Project", Destructive = true, Idempotent = true)]

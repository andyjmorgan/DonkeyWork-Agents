...
public class AgentsController : ControllerBase
{
    ...
    [HttpPost]
    [ProducesResponseType<CreateAgentResponseV1>(StatusCodes.Status201Created)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> Create([FromBody] CreateAgentRequestV1 request)
    {
    ...
    [HttpGet("{id:guid}")]
    [ProducesResponseType<GetAgentResponseV1>(StatusCodes.Status200OK)]
    ...
    [HttpGet]
    [ProducesResponseType<IReadOnlyList<GetAgentResponseV1>>(StatusCodes.Status200OK)]
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> Update(Guid id, [FromBody] CreateAgentRequestV1 request)
    {

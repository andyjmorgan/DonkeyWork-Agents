...
public class AgentExecutionRepository : IAgentExecutionRepository
{
    ...
    public AgentExecutionRepository(AgentsDbContext dbContext)
    {
    ...
    public async Task<(IReadOnlyList<GetExecutionResponseV1> Executions, int TotalCount)> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var query = _dbContext.AgentExecutions.AsNoTracking();
    ...
    private static GetExecutionResponseV1 MapToResponse(AgentExecutionEntity execution)
    {
        return new GetExecutionResponseV1
        {
            Id = execution.Id,
            AgentId = execution.AgentId,
            VersionId = execution.AgentVersionId,
    ...
    private static ExecutionLogV1 MapLogToResponse(AgentExecutionLogEntity log)
    {

...
public class AgentNodeExecutionConfiguration : IEntityTypeConfiguration<AgentNodeExecutionEntity>
{
    public void Configure(EntityTypeBuilder<AgentNodeExecutionEntity> builder)
    {
        builder.ToTable("agent_node_executions", "agents");
        ...
        builder.Property(e => e.AgentExecutionId)

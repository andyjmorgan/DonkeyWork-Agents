...
export function ProjectsPage({ nav }: { nav: WorkspaceNavigation }) {
        ...
        <>
          ...
          <div className="hidden md:block rounded-md border">
            <Table>
              ...
              <TableBody>
                {projectsList.map((project) => (
                  <TableRow key={project.id} className="cursor-pointer" onClick={() => nav.goToProject(project.id)}>
                    <TableCell>
                      <div className="font-medium">{project.name}</div>
                    </TableCell>
                    <TableCell>

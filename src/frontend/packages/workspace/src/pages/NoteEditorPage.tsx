...
export function NoteEditorPage({ noteId, nav }: { noteId: string; nav: WorkspaceNavigation }) {
  ...
  if (!note) {
    return (
      <div className="flex flex-col items-center justify-center h-64">
        ...
        <Button variant="outline" className="mt-4" onClick={() => nav.goToNotesList()}>

...
export function MilestoneDetailPage({ projectId, milestoneId, nav }: { projectId: string; milestoneId: string; nav: WorkspaceNavigation }) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 min-w-0">
          <Button variant="ghost" size="icon" onClick={() => nav.goToProject(projectId)}>
            <ArrowLeft className="h-5 w-5" />
          </Button>
          <div className="flex items-center gap-2 text-sm text-muted-foreground min-w-0">
            <button
              onClick={() => nav.goToProject(projectId)}

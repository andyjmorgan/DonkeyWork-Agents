...
import { Bot, Key, KeyRound, Lock, X, PlayCircle, List, FolderKanban, CheckSquare, StickyNote, Folder, FolderOpen, Shield, Link as LinkIcon, Bubbles, File, Server, Globe, FlaskConical, Plus, ChevronDown, MessageSquare, Zap, Brain, Plug, Hammer, Volume2, Calendar, Cpu, Activity } from 'lucide-react'
...
const navigationGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'Collections', href: '/audio-collections', icon: FolderOpen, iconColor: 'text-pink-500' },

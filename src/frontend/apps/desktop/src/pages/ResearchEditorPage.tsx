...
export function ResearchEditorPage({ researchId, onBack }: ResearchEditorPageProps) {
  const isNew = researchId === null
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {/* Completion Notes (visible for terminal statuses) */}
        {(status === 'Completed' || status === 'Cancelled') && completionNotesValue && (
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder={status === 'Completed' ? 'What was accomplished...' : 'Why was this cancelled...'}
              rows={3}
            />
          </div>
        )}

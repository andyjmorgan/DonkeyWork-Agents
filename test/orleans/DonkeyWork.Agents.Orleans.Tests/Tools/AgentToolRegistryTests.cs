...
public class AgentToolRegistryTests
{
    ...
    public async Task ExecuteAsync_WithValidTool_ReturnsResult()
    {
        ...
        // Act
        var result = await registry.ExecuteAsync("test_tool_a", input, context, CancellationToken.None);
    ...
    public async Task ExecuteAsync_WithNonExistentTool_ReturnsError()
    {
        ...
        // Act
        var result = await registry.ExecuteAsync("nonexistent", input, context, CancellationToken.None);
    ...
    public async Task ExecuteAsync_WithScopeTypes_RejectsOutOfScope()
    {
        ...
        var result = await registry.ExecuteAsync(
            "test_tool_a", input, context, CancellationToken.None,
    ...
    public async Task ExecuteAsync_WhenToolThrows_ReturnsError()
    {
        ...
        // Act
        var result = await registry.ExecuteAsync("throwing_tool", input, context, CancellationToken.None);

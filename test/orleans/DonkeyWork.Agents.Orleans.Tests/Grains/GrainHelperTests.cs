...
using DonkeyWork.Agents.Orleans.Core.Grains;
using Xunit;

namespace DonkeyWork.Agents.Orleans.Tests.Grains;
...
public class GrainHelperTests
{
    ...
    {
        // Act
        var types = SharedGrainHelpers.ResolveToolGroups(["swarm_spawn", "swarm_management"]);
    ...
    {
        // Act
        var types = SharedGrainHelpers.ResolveToolGroups(["swarm_spawn", "nonexistent", "swarm_delegate"]);
...
internal static class SharedGrainHelpers
{
    ...
    {
        ["swarm_spawn"] = typeof(DonkeyWork.Agents.Orleans.Core.Tools.Swarm.SwarmSpawnTools),
        ["swarm_delegate"] = typeof(DonkeyWork.Agents.Orleans.Core.Tools.Swarm.SwarmDelegateSpawnTools),
        ["swarm_management"] = typeof(DonkeyWork.Agents.Orleans.Core.Tools.Swarm.SwarmAgentManagementTools),
    };

...
public class ConversationRpcTargetTests
{
    ...
    public async Task Cancel_WithKnownPrefix_PassesKeyThrough()
    {
        ...
        // Act
        await target.Cancel("custom:11111111-1111-1111-1111-111111111111:22222222-2222-2222-2222-222222222222:33333333-3333-3333-3333-333333333333", "active");

        // Assert — known prefix passes through unchanged
        grain.Verify(g => g.CancelByKeyAsync("custom:11111111-1111-1111-1111-111111111111:22222222-2222-2222-2222-222222222222:33333333-3333-3333-3333-333333333333", "active"), Times.Once);
    }
